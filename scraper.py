...
pros=review.select_one("div.review-feature__title--positives ~ div.review-feature__item")
cons=review.select_one("div.review-feature__title--negatives ~ divreview-feature__item")
...
review_date=review.select_one("pan.user-post__published > time:nth-child(1)")["datetime"].strip()
